...
execute_process(COMMAND "${GIT_EXECUTABLE}" -C ${bgfx_SOURCE_DIR} log --pretty=format:'%h' -n 1
                OUTPUT_VARIABLE GIT_REV
                ERROR_QUIET)

execute_process(COMMAND "${GIT_EXECUTABLE}" -C ${bgfx_SOURCE_DIR} rev-list --count HEAD
                OUTPUT_VARIABLE GIT_REV_COUNT
                ERROR_QUIET)

# read version(100) from bgfx.idl
file(READ "${bgfx_SOURCE_DIR}/scripts/bgfx.idl" BGFX_IDL)
