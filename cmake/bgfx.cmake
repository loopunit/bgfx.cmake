...
if( BGFX_CONFIG_RENDERER_WHITELIST )
	if( BGFX_CONFIG_RENDERER_DIRECT3D9 )
		target_compile_definitions( bgfx PUBLIC "BGFX_CONFIG_RENDERER_DIRECT3D9=1" )
	endif()
	if( BGFX_CONFIG_RENDERER_DIRECT3D11 )
		target_compile_definitions( bgfx PUBLIC "BGFX_CONFIG_RENDERER_DIRECT3D11=1" )
	endif()
	if( BGFX_CONFIG_RENDERER_DIRECT3D12 )
		target_compile_definitions( bgfx PUBLIC "BGFX_CONFIG_RENDERER_DIRECT3D12=1" )
	endif()
	if( BGFX_CONFIG_RENDERER_GNM )
		target_compile_definitions( bgfx PUBLIC "BGFX_CONFIG_RENDERER_GNM=1" )
	endif()
	...
	if( BGFX_CONFIG_RENDERER_NVN )
		target_compile_definitions( bgfx PUBLIC "BGFX_CONFIG_RENDERER_NVN=1" )
	endif()
